...
# - Ponte H conectada ao ESP32 com pinos especiais para o PWM.

class Hbridge_Speed_Pins:
    

# - Denomina os pinos quando chama a classe sendo, em ordem: n1; n2; n3; n4; pwm1; pwm2.
#  
# Exemplo: Hbridge_Speed_Pins(12, 14, 27, 26, 25, 33)
    
    def __init__(self, n1, n2, n3, n4, pwm1, pwm2):
        self.n1 = Pin(n1, Pin.OUT)
        self.n2 = Pin(n2, Pin.OUT)
        self.n3 = Pin(n3, Pin.OUT)
        self.n4 = Pin(n4, Pin.OUT)
        self.pwm1 = PWM(Pin(pwm1), freq=5000, duty=0)
        self.pwm2 = PWM(Pin(pwm2), freq=5000, duty=0)
        self.min_speed = 0
...
#
# Exemplo: 
#               Hbridge_Speed_Pins.Run("Right", "CCW", 70)
...
#   
# Exemplo:
#               Hbridge_Speed_Pins.min_speed_config(200)
#
